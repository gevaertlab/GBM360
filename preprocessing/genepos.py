# Re-implemtentation of the `genomic_position_from_gtf`` function from infercnvpy:
# https://github.com/icbi-lab/infercnvpy/blob/main/src/infercnvpy/io/_genepos.py

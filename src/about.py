...
def app():
    ...
    with st.expander("Disclaimer"):
        ...
        st.markdown("""Please remove all <a href='https://med.stanford.edu/irt/security/stanfordinfo/hipaa.html'>Personal Health Information (PHI)</a> from all uploaded files, as we are not responsible for data compliance issues""")
